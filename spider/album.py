...
try:
    cur.execute("create table albumsound(id int PRIMARY KEY AUTO_INCREMENT, albumtitle varchar(255), music_type VARCHAR (255),author VARCHAR(255),playcount VARCHAR (255), tag VARCHAR(255), starttime varchar (255), endtime varchar(255), albumurl varchar(255))")
...
for tag in sound_tag:
    urltab = 'http://www.ximalaya.com%srecnet' % tag['href']     #urltab是大分类链接
