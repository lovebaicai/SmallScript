...
class XmlyMysqlPipeline(object):
    ...
    def process_item(self, item, spider):
        sql = """insert into %s (Title, Albumtitle, SinglePlayCount, Albumscore, LikeCount, CommentsCount,
                TotalPlayCounts, Duration, CreatedTime, displayDiscountedPrice, Nickname, category_title, trackId)
                values (item['Title'], item['Albumtitle'], item['SinglePlayCount'], item['Albumscore'],
        ...
        # self.cursor.execute(
        #     "insert into tabname(Title, Albumtitle, SinglePlayCount, Albumscore, LikeCount, CommentsCount,"
        #     "TotalPlayCounts, Duration, CreatedTime, displayDiscountedPrice, Nickname, category_title, trackId) values"
