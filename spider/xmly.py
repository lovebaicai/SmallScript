...
class Ximalaya(threading.Thread):
    ...
    def run(self):
        while not exit_flag.is_set():
            ...
            print '*** Album done, url: %s, Queue: %s, Queue_in: %s, Page: %s ***' % (
            album_url, self.queue.qsize(), self.queue_in.qsize(), page)
        ...
        try:
            ...
            if sound_urls:
                for sound_url in sound_urls:
                    ...
                    if not exists_flag:
                        print '>>> Sound put %s, Queue: %s, Queue_in: %s, Page: %s' % (
                        sound_url, self.queue.qsize(), self.queue_in.qsize(), page)
...
class CommentDown(threading.Thread):
    ...
    def run(self):
        while not exit_flag.is_set():
            ...
            print '*** Comment done, url: %s ***, Queue: %s, Queue_In: %s, Page: %s' % (
            url, self.queue.qsize(), self.queue_in.qsize(), page)
